...
export default class API {
    ...
    static post(url: string, request: any, config: any = {}): Promise<AxiosResponse<any, any>> {
        return axios.post(url, request, {...defaultConfig, ...config})
    }

    static put(url: string, request: any, config: any = {}): Promise<AxiosResponse<any, any>> {
        return axios.put(url, request, {...defaultConfig, ...config})
    }

    static delete(url: string, config: any = {}): Promise<AxiosResponse<any, any>> {
