...
export interface ChatbotResponse {
  state: {
    message: string;
    isAnswering: boolean;
    currentQuestion: NumericalQuestion | MultipleChoiceQuestion | TrueOrFalseQuestion | undefined;
    questionList: (NumericalQuestion | MultipleChoiceQuestion | TrueOrFalseQuestion)[] | undefined;
